...
/* SCRIVI QUI LA TUA RISPOSTA */
let numeroUgualeCinque = 6;
if(numeroUgualeCinque !== 5){
...
/* SCRIVI QUI LA TUA RISPOSTA */
let numeroDivisibilePerCinque = 50;
...
let checkNumero = 20;
console.log( typeof(checkNumero) === 'number');
...
let checkPari = 29;
if( checkPari % 2 === 0){
  console.log(checkPari + ' è pari');
}else{
  console.log(checkPari + ' è dispari');
}
